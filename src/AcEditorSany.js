...
class AcEditorSany extends Component {
  ...
  render() {
    ...
    const { editorId, height,sanyTheme,contentEditable } = this.props;

    return (
      <div className="editor-sany">

        <div className="toolbar-sany" contentEditable={false}>
          {/*预览*/}
        ...
        <div
          ...
          contentEditable={(contentEditable !== undefined) ? contentEditable:false}
